...
//
// This is an unofficial fork of the official Window List GNOME extension
//
...
class BaseButton extends DashItemContainer {
    ...
    showLabel() {
        let labelText = this.label_actor.text;
        ...
        const y = stageY + this.label.height + TOOLTIP_OFFSET;
...
class WindowList extends St.Widget {
    ...
    constructor(perMonitor, monitor, settings) {
        ...
        let indicatorsBox = new St.BoxLayout({x_align: Clutter.ActorAlign.START});
...
export default class WindowListExtension extends Extension {
    ...
    someWindowListContains(actor) {
        return this._windowList.contains(actor);
    }
}
